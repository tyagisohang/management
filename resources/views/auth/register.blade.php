                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="user_type" id="user_type" value="{{ old('user_type') }}" class="form-control @error('user_type') is-invalid @enderror">
                                    <option value="NULL">Select User Type</option>
                                    <option value="Contractor">Contractor</option>
                                    <option value="Self_Contractor">Self Contractor</option>
                                </select>
                    ...
                    <div class="row mb-0">
                        <div class="col-md-6 offset-md-4">
                            OR <br>
                            <a href="{{ route('login.google') }}" id="loginButton"><button class="btn btn-danger">
